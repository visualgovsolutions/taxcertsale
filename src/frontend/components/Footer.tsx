      ...
      <div className="max-w-screen-xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-red-600 text-xl font-bold mb-4">Tax Cert Sale</h2>
            <p className="text-gray-400 mb-4">
              Simplifying the tax certificate sales process for everyone involved.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-sm">
          <p>© {currentYear} Tax Cert Sale. All rights reserved.</p>
          <p className="mt-4 md:mt-0">
            <Link to="/privacy" className="hover:text-white mr-4">Privacy</Link>
