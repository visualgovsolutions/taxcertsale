...
async function testFlowbiteStyles() {
    ...
    try {
        ...
        const styleCheck = await page.evaluate(() => {
            ...
            const flowbiteElements = document.querySelectorAll('.bg-gray-50, .dark\\:bg-gray-700, .text-gray-900, .dark\\:text-white');
            ...
            const hasAppliedStyles = loginButton && (buttonStyles.backgroundColor !== 'rgba(0, 0, 0, 0)' && // Not transparent
...
//# sourceMappingURL=flowbite-visual-test.js.map